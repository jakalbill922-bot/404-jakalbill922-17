    ...
    async def generate_gs(self, request: GenerateRequest) -> GenerateResponse:
        ...
        if default_feature:
            ...
            image_edited = self.qwen_edit.edit_image(
                prompt_image=image,
                seed=request.seed,
                prompt="Show this vivid object in left three-quarters view and make sure it is fully visible in space. Turn background black color contrasting with an object. Persist near object on background. Keep object colors and pose and texture. Sharpen image details.",
            )
            # 2. Remove background
            image_without_background = self.rmbg.remove_background(image_edited)
            ...
            image_edited_2 = self.qwen_edit.edit_image(
                prompt_image=image,
                seed=request.seed,
                prompt="Show this vivid object in right three-quarters view and make sure it is fully visible in space. Turn background black color contrasting with an object. Persist near object on background. Keep object colors and pose and texture. Sharpen image details.",
            )
            ...
            #     prompt_image=image,
            #     seed=request.seed,
            #     prompt="Show this vivid object in back three-quarters view and make sure it is fully visible in space. Turn background black color contrasting with an object. Persist near object on background.  Keep object colors and pose and texture. Sharpen image details.",
            # )
            image_without_background_3 = self.rmbg.remove_background(image)
            trellis_result: Optional[TrellisResult] = None

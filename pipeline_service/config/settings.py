...
class Settings(BaseSettings):
    ...
    trellis_sparse_structure_cfg_strength: float = Field(default=5.0, env="TRELLIS_SPARSE_STRUCTURE_CFG_STRENGTH")
    trellis_slat_steps: int = Field(default=26, env="TRELLIS_SLAT_STEPS")
